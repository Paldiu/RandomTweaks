package dev.coomware.libs.config;
...
public class Config extends YamlConfiguration {
    ...
    public Config(Plugin plugin, String fileName, boolean copyDefaults) {
        this(plugin, CoomLibs.reflect.getPluginFile(plugin, fileName), copyDefaults);
    }
    ...
    public YamlConfiguration getDefaultConfigurationFile() {
        ...
        try {
            CONFIG.load(CoomLibs.reflect.getPluginFile(plugin, "config.yml"));
        } catch (IOException | InvalidConfigurationException ex) {
