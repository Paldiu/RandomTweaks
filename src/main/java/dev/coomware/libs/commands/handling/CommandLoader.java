...
public class CommandLoader {
    ...
    public void scan() {
        ...
        Plugin plug = CoomLibs.reflect.getPlugin();
        if (map == null) {
    ...
    public CommandMap getCommandMap() {
        Object commandMap = CoomLibs.reflect.getField(Bukkit.getServer().getPluginManager(), "commandMap");
        if (commandMap != null) {
    ...
    private List<? extends Commander> getCommands() {
        ...
        CoomLibs.reflect.getAnnotatedClasses(CommandParameters.class).forEach(clazz -> {
    ...
    public Map<String, Command> getKnownCommands(CommandMap commandMap) {
        Object knownCommands = CoomLibs.reflect.getField(commandMap, "knownCommands");
        if (knownCommands != null) {
